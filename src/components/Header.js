...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 grid grid-flow-col p-6 shadow-md items-center bg-white">
      ...
      <div className="col-span-10">
        ...
        {showSuggestions && (
          <div className="fixed w-[41.5rem] border border-gray-200 border-t-0 rounded-xl shadow-md">
            {searchSuggestions.map((suggestions) => (
              <li
                key={suggestions}
                className="bg-white p-2 list-none flex gap-4 items-center hover:bg-slate-100 cursor-default"
                onClick={() => {
